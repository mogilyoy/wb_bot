...
stock = {2022752346005: '🍄🍄🍄Мухомор ежовик гребенчатый🍄🍄🍄', 2022751900000:'🍄🍄🍄Ежовик гребенчатый🍄🍄🍄', 2012916817014: '👕👕👕Кигуруми пикачу👕👕👕', 2012917331014: '👕👕👕Кигуруми тигр))👕👕👕'}
...
def beautiful_order_messages_status12(message):
    ...
    for order in all_orders:
        ...
        barcode = wb.order_stickers([order_id])['data'][0]['sticker']['wbStickerId']  # ['data']['sticker']['wbStickerId']
        print(barcode)
        # barcode =f"{barcode['A']}{barcode['B']}"
