...
def menu():
    ...
    all_buttons = InlineKeyboardMarkup([[button1],[button2], [button3], [button4], [button5]], row_width=1)
    return all_buttons
...
def make_new_supply():
    button2 = InlineKeyboardButton('Добавить заказы в поставочку', callback_data='put_orders_in_supply')
    button3 = InlineKeyboardButton('<<Назад', callback_data='back')
    all_buttons = InlineKeyboardMarkup([[button2], [button3]], row_width=1)
    return all_buttons
